        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('aeo.questions.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    id="subcriteria" name="subcriteria" value="<?php echo e(old('subcriteria')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="question" name="question" rows="4"
                                    required><?php echo e(old('question')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="jawaban" name="jawaban" rows="3"><?php echo e(old('jawaban')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\aeo-docs\resources\views/aeo/questions/create.blade.php ENDPATH**/ ?>