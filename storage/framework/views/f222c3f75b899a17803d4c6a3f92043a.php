            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">
                            <i class="fas fa-file-excel"></i> Import AEO Questions dari Excel
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="alert alert-info">
                            ...
                            <ol class="mb-0">
                                ...
                                <li>Isi data pertanyaan sesuai format template</li>
                        ...
                        <div class="mb-4">
                            <a href="<?php echo e(route('aeo.questions.download.template')); ?>" class="btn btn-success">
                                <i class="fas fa-download"></i> Download Template CSV
                            </a>
                        </div>

                        <form method="POST" action="<?php echo e(route('aeo.questions.import')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Kode subcriteria (harus unik)</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Keterangan tambahan untuk pertanyaan</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\aeo-docs\resources\views/aeo/questions/import.blade.php ENDPATH**/ ?>