                ...
                <div class="card">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted">
                                    Subcriteria: <strong><?php echo e($question->subcriteria); ?></strong>
                                </small>
                            </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?php echo e($question->question); ?></p>

                                        <?php if($question->jawaban): ?>
                                            <h6 class="card-subtitle mb-2 text-muted mt-3">Answer</h6>
                                            <p class="card-text"><?php echo e($question->jawaban); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-header bg-primary text-white">
                                        <h5 class="mb-0">
                                            ...
                                            <span class="badge bg-light text-dark ms-2">
                                                <?php echo e($question->documents->where('document_type', 'master')->count()); ?>
                                                ...
                                                <div class="border rounded p-3 mb-3">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div class="flex-grow-1">
                                                            <h6 class="text-primary mb-2"><?php echo e($doc->nama_dokumen); ?></h6>
                                                            ...
                                                            <p class="text-muted mb-1">
                                                                <small><i class="fas fa-building"></i>
                                                                    <?php echo e($doc->dept); ?></small>
                                                            </p>

                                                            <p class="text-muted mb-2">
                                                                <small><i class="fas fa-clock"></i> Updated:
                                                                    <?php echo e($doc->updated_at->format('d/m/Y H:i')); ?></small>
                                                            </p>
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    data-bs-target="#validationModal<?php echo e($doc->id); ?>"
                                                                    title="Toggle Validation">
                                                                    <i class="fas fa-toggle-on"></i> Toggle
                                                                </button>

                                                                <?php if($doc->aeo_manager_valid !== null): ?>
                                                                    <span
                                                                        class="badge <?php echo e($doc->aeo_manager_valid ? 'bg-success' : 'bg-warning'); ?> ms-1">
                                                                        <i class="fas fa-user-shield"></i>
                                                                        AEO Mgr:
                                                                        <?php echo e($doc->aeo_manager_valid ? 'Valid' : 'Invalid'); ?>
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-document-id="<?php echo e($doc->id); ?>"
                                                            ...
                                                            <?php if($doc->files && count($doc->files) > 0): ?>
                                                                <div class="mt-3">
                                                                    ...
                                                                    <?php $__currentLoopData = $doc->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <div class="mb-2">
                                                                            <a href="<?php echo e(Storage::url($file)); ?>"
                                                                                target="_blank"
                                                            ...
                                                            <?php if($doc->validation_files && count($doc->validation_files) > 0): ?>
                                                                <div class="mt-3">
                                                                    ...
                                                                    <?php $__currentLoopData = $doc->validation_files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <div class="mb-2">
                                                                            <a href="<?php echo e(Storage::url($file)); ?>"
                                                                                target="_blank"
                                                            ...
                                                            <?php if($doc->aeo_manager_notes): ?>
                                                                <div class="alert alert-info mt-3">
                                                                    <small><strong>AEO Manager Notes:</strong>
                                                                        <?php echo e($doc->aeo_manager_notes); ?></small>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                            ...
                            <?php $__currentLoopData = $question->documents->where('document_type', 'master'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="modal fade" id="validationModal<?php echo e($doc->id); ?>" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="<?php echo e(route('aeo.documents.toggle-validation', $doc)); ?>"
                                                method="POST">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <strong>Document:</strong> <?php echo e($doc->nama_dokumen); ?>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="is_valid" id="isValid<?php echo e($doc->id); ?>"
                                                                value="1" <?php echo e($doc->is_valid ? 'checked' : ''); ?>>
                                                            <label class="form-check-label"
                                                                for="isValid<?php echo e($doc->id); ?>">
                                                                Mark as Valid
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="validationNotes<?php echo e($doc->id); ?>"
                                                            class="form-label">
                                                            Validation Notes (optional)
                                                        </label>
                                                        <textarea class="form-control" name="validation_notes" id="validationNotes<?php echo e($doc->id); ?>" rows="3"
                                                            placeholder="Add notes about the validation..."><?php echo e($doc->validation_notes); ?></textarea>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="validationFiles<?php echo e($doc->id); ?>"
                                                            class="form-label">
                                                            Validation Files (optional)
                                                        </label>
                                                        <input type="file" class="form-control"
                                                            name="validation_files[]"
                                                            id="validationFiles<?php echo e($doc->id); ?>" multiple
                                ...
                                <div class="card">
                                    <div class="card-header bg-success text-white">
                                        <h5 class="mb-0">
                                            ...
                                            <span class="badge bg-light text-dark ms-2">
                                                <?php echo e($question->documents->where('document_type', 'new')->count()); ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if($newDocs->count() > 0): ?>
                                            <?php $__currentLoopData = $newDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="border rounded p-3 mb-3">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div class="flex-grow-1">
                                                            <h6 class="text-success mb-2"><?php echo e($doc->nama_dokumen); ?></h6>
                                                            ...
                                                            <p class="text-muted mb-2">
                                                                <small><i class="fas fa-clock"></i> Created:
                                                                    <?php echo e($doc->created_at->format('d/m/Y H:i')); ?></small>
                                                            </p>
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <?php if($doc->aeo_manager_valid !== null): ?>
                                                                    <span
                                                                        class="badge <?php echo e($doc->aeo_manager_valid ? 'bg-success' : 'bg-danger'); ?> ms-1">
                                                                        <i class="fas fa-user-shield"></i>
                                                                        AEO Mgr:
                                                                        <?php echo e($doc->aeo_manager_valid ? 'Valid' : 'Invalid'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\aeo-docs\resources\views/aeo/questions/documents.blade.php ENDPATH**/ ?>